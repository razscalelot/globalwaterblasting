...
router.get('/housewashing', async (req, res) => {
    ...
    if (serviceData && serviceData != null) {
        let seo = {
            ...
            canonical: 'https://globalwaterblasting.co.nz/services/housewashing',
            ogtype: 'website',
            ogtitle: serviceData.servicename + ' - Global Water Blasting NZ',
            ogurl: 'https://globalwaterblasting.co.nz/services/housewashing',
            ogimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            ...
            twittersite: '@https://globalwaterblasting.co.nz/services/housewashing',
...
router.get('/fencepatiocleaning', async (req, res) => {
    ...
    if (serviceData && serviceData != null) {
        let seo = {
            title: serviceData.servicename + ' - Global Water Blasting NZ',
            description: serviceData.shortdesc,
            canonical: 'https://globalwaterblasting.co.nz/services/fencepatiocleaning',
            ogtype: 'website',
            ogtitle: serviceData.servicename + ' - Global Water Blasting NZ',
            ogurl: 'https://globalwaterblasting.co.nz/services/fencepatiocleaning',
            ogimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            ogdescription: serviceData.shortdesc,
            articleauthor: 'globalwaterblasting.co.nz',
            articlemodified_time: '2022-08-11T16:21+12:00',
            ...
            twittercard: 'summary',
            twittertitle: serviceData.servicename + ' - Global Water Blasting NZ',
            twittersite: '@https://globalwaterblasting.co.nz/services/fencepatiocleaning',
            twitterdescription: serviceData.shortdesc,
            twitterimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            twitterimagealt: 'Globalwaterblastinglogo'
        }
...
router.get('/drivewaysidewalkwash', async (req, res) => {
    ...
    if (serviceData && serviceData != null) {
        let seo = {
            title: serviceData.servicename + ' - Global Water Blasting NZ',
            description: serviceData.shortdesc,
            canonical: 'https://globalwaterblasting.co.nz/services/drivewaysidewalkwash',
            ogtype: 'website',
            ogtitle: serviceData.servicename + ' - Global Water Blasting NZ',
            ogurl: 'https://globalwaterblasting.co.nz/services/drivewaysidewalkwash',
            ogimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            ogdescription: serviceData.shortdesc,
            articleauthor: 'globalwaterblasting.co.nz',
            articlemodified_time: '2022-08-11T16:21+12:00',
            ...
            twittercard: 'summary',
            twittertitle: serviceData.servicename + ' - Global Water Blasting NZ',
            twittersite: '@https://globalwaterblasting.co.nz/services/drivewaysidewalkwash',
            twitterdescription: serviceData.shortdesc,
            twitterimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            twitterimagealt: 'Globalwaterblastinglogo'
        }
...
router.get('/roofmossmouldtreatment', async (req, res) => {
    ...
    if (serviceData && serviceData != null) {
        let seo = {
            title: serviceData.servicename + ' - Global Water Blasting NZ',
            description: serviceData.shortdesc,
            canonical: 'https://globalwaterblasting.co.nz/services/roofmossmouldtreatment',
            ogtype: 'website',
            ogtitle: serviceData.servicename + ' - Global Water Blasting NZ',
            ogurl: 'https://globalwaterblasting.co.nz/services/roofmossmouldtreatment',
            ogimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            ogdescription: serviceData.shortdesc,
            articleauthor: 'globalwaterblasting.co.nz',
            articlemodified_time: '2022-08-11T16:21+12:00',
            ...
            twittercard: 'summary',
            twittertitle: serviceData.servicename + ' - Global Water Blasting NZ',
            twittersite: '@https://globalwaterblasting.co.nz/services/roofmossmouldtreatment',
            twitterdescription: serviceData.shortdesc,
            twitterimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            twitterimagealt: 'Globalwaterblastinglogo'
        }
...
router.get('/guttercleaning', async (req, res) => {
    ...
    if (serviceData && serviceData != null) {
        let seo = {
            title: serviceData.servicename + ' - Global Water Blasting NZ',
            description: serviceData.shortdesc,
            canonical: 'https://globalwaterblasting.co.nz/services/guttercleaning',
            ogtype: 'website',
            ogtitle: serviceData.servicename + ' - Global Water Blasting NZ',
            ogurl: 'https://globalwaterblasting.co.nz/services/guttercleaning',
            ogimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            ogdescription: serviceData.shortdesc,
            articleauthor: 'globalwaterblasting.co.nz',
            articlemodified_time: '2022-08-11T16:21+12:00',
            ...
            twittercard: 'summary',
            twittertitle: serviceData.servicename + ' - Global Water Blasting NZ',
            twittersite: '@https://globalwaterblasting.co.nz/services/guttercleaning',
            twitterdescription: serviceData.shortdesc,
            twitterimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            twitterimagealt: 'Globalwaterblastinglogo'
        }
...
router.get('/deckwash', async (req, res) => {
    ...
    if (serviceData && serviceData != null) {
        let seo = {
            title: serviceData.servicename + ' - Global Water Blasting NZ',
            description: serviceData.shortdesc,
            canonical: 'https://globalwaterblasting.co.nz/services/deckwash',
            ogtype: 'website',
            ogtitle: serviceData.servicename + ' - Global Water Blasting NZ',
            ogurl: 'https://globalwaterblasting.co.nz/services/deckwash',
            ogimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            ogdescription: serviceData.shortdesc,
            articleauthor: 'globalwaterblasting.co.nz',
            articlemodified_time: '2022-08-11T16:21+12:00',
            ...
            twittercard: 'summary',
            twittertitle: serviceData.servicename + ' - Global Water Blasting NZ',
            twittersite: '@https://globalwaterblasting.co.nz/services/deckwash',
            twitterdescription: serviceData.shortdesc,
            twitterimage: 'https://globalwaterblasting.co.nz/assets/images/logo.png',
            twitterimagealt: 'Globalwaterblastinglogo'
        }
